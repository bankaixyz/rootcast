    ...
    <footer className="site-footer">
      <div className="site-footer__inner">
        <div className="site-footer__left">
          <span className="site-footer__brand">World ID Rootcast</span>
        ...
        <div className="site-footer__links">
          ...
          <a href="https://github.com/bankaixyz/rootcast" className="site-footer__link" target="_blank" rel="noreferrer">
            GitHub
          </a>
          <a
